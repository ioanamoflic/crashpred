...
posterior_year_weight <- summary(fit_result, pars = c('intercept', 'year_weight', 'oxygen_weight'))$summary[4, 1]
posterior_oxygen_weight <- summary(fit_result, pars = c('intercept', 'year_weight', 'oxygen_weight'))$summary[5, 1]

posteior_f1 <- function(x) 1/(1+exp( - (posterior_intercept_everest + posterior_year_weight * (x - 1980)/8)/100 ))  

posteior_f2 <- function(x) 1/(1+exp( - (posterior_intercept_everest + posterior_year_weight * (x - 1980)/8 + posterior_oxygen_weight)/100 )) 
